...
{
    allWpFoodMenu(
        filter: {menuCategories: {nodes: {elemMatch: {slug: {eq: "seafood-dishes"}}}}}
        sort: {fields: date}
      )  {
      edges {
        node {
...
function SeafoodMains() {
  ...
  return (
    <Container>
      <LineTitle marginTop={true}>Seafood Dishes</LineTitle>
      {menuItems}
    </Container>
  )
}
