...
{
    allWpFoodMenu(
        filter: {menuCategories: {nodes: {elemMatch: {slug: {eq: "vegetarian-delights"}}}}}
        sort: {fields: date}
      )  {
      edges {
        node {
...
function VegetarianMains() {
  ...
  return (
    <Container>
      <LineTitle marginTop={true}>Vegetarian Delights</LineTitle>
      {menuItems}
    </Container>
  )
}
...
export default VegetarianMains
